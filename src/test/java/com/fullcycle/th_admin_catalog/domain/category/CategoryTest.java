...
public class CategoryTest {
    ...
    @Test
    public void givenAInvalidEmptyNameParameterWhenCreateCategoryThenShouldReceiveError()  {
    ...
    @Test
    public void givenAnInvalidNameParameterWhenCreateCategoryThenShouldReceiveError() {
    ...
    @Test
    public void givenAnInvalidNameLengthMoreThan255ParameterWhenCreateCategoryThenShouldReceiveError() {
    ...
    @Test
    public void givenAValidEmptyDescriptionWhenCallNewCategoryAndValidateThenShouldReceiveOK() {
        final var expectedName = "Filmes";
    ...
    @Test
    public void givenAValidFalseIsActiveWhenCallNewCategoryAndValidateThenShouldReceiveOK() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
    ...
    @Test
    public void givenAValidActiveCategoryWhenCallDeactivateThenReturnCategoryInactivated() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = false;
